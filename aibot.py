...
def response_generator():
    response = ai_ask("Suppose you are a witch doctor.  Please provide a greeting if there is no additional context, or provide a response based on the existing context.  Please provide the response only with no before or after commentary.",
